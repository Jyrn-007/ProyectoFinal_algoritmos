...
namespace ejersuma {
	...
	/// Resumen de cuatro
	/// </summary>
	public ref class cuatro : public System::Windows::Forms::Form
	{
	public:
		cuatro(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(cuatro::typeid));
			...
			this->button6->Click += gcnew System::EventHandler(this, &cuatro::button6_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &cuatro::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Text = L"79";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &cuatro::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 28, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(309, 398);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(146, 77);
			this->button2->TabIndex = 41;
			this->button2->Text = L"60";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &cuatro::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 28, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(60, 398);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(146, 77);
			this->button1->TabIndex = 40;
			this->button1->Text = L"77";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &cuatro::button1_Click);
			// 
			// cuatro
			// 
