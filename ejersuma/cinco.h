...
namespace ejersuma {
	...
	/// Resumen de cinco
	/// </summary>
	public ref class cinco : public System::Windows::Forms::Form
	{
	public:
		cinco(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(cinco::typeid));
			...
			this->pictureBox2->Location = System::Drawing::Point(331, 224);
			...
			this->pictureBox1->Location = System::Drawing::Point(280, 14);
			...
			this->pictureBox3->Location = System::Drawing::Point(331, 224);
			...
			this->label3->Location = System::Drawing::Point(73, 547);
			...
			this->button6->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button6->Location = System::Drawing::Point(589, 776);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(164, 52);
			this->button6->TabIndex = 44;
			this->button6->Text = L"Siguiente";
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &cinco::button6_Click);
			// 
			// button4
			// 
			this->button4->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button4->Location = System::Drawing::Point(225, 774);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(162, 55);
			this->button4->TabIndex = 43;
			this->button4->Text = L"Reintentar";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &cinco::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 28, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(495, 414);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(146, 77);
			this->button3->TabIndex = 42;
			this->button3->Text = L"550";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &cinco::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Text = L"539";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &cinco::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 28, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(301, 414);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(146, 77);
			this->button1->TabIndex = 40;
			this->button1->Text = L"540";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &cinco::button1_Click);
			// 
			// cinco
			// 
